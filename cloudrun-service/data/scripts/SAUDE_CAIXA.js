// SAUDE CAIXA • Inserção em lote (baseline)
void setTimeout(async () => {
  try {
    ...
    for (const code of codigos) {
      ...
      if (!evento) {
        alert("Campo EVENTO não encontrado. Ajuste SAUDE_CAIXA.AMBOS.js");
        return;
      }
      evento.focus();
      evento.value = "";
      ...
      console.log("✔ SAUDE CAIXA inserido:", code);
      await delay(1800);
    }

    console.log("🎉 SAUDE CAIXA finalizado.");
  } catch (e) {
    console.error("❌ SAUDE CAIXA erro:", e);
  }
}, 0);
