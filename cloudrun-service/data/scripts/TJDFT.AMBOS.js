// TJDFT • Inserção em lote (baseline)
// Ajuste seletores se o portal mudar.
void setTimeout(async () => {
  try {
    ...
    for (const code of codigos) {
      ...
      if (!field) {
        alert("Campo #HandleTermo não encontrado. Ajuste TJDFT.AMBOS.js");
        return;
      }
      field.focus();
      field.value = "";
      ...
      if (row) {
        ...
        console.warn("Sem resultado para:", code);
      }

      await delay(800);
    }

    console.log("🎉 TJDFT finalizado.");
  } catch (e) {
    console.error("❌ TJDFT erro:", e);
  }
}, 0);
